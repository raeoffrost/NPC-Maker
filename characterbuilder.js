document.addEventListener("DOMContentLoaded", () => {
    ...
    const randomizeValues = () => {
        ...
        document.querySelectorAll(".check-saving").forEach(input => {
            input.checked = Math.random() > 0.85; // Changed chance of saving throw
        });
        document.querySelectorAll(".check-skills").forEach(input => {
